...
class ActionsCfg:
    ...
    joint_pos = mdp.JointPositionActionCfg(
        asset_name="robot",
        joint_names=["Left_HIP_AA", "Left_THIGH_FE", "Left_KNEE_FE", "Left_FOOT_ANKLE", "Right_HIP_AA", "Right_THIGH_FE", "Right_SHIN_FE", "Right_FOOT_ANKLE"], 
        scale=0.25,
...
class RewardsCfg:
    ...
    rew_no_fly = RewTerm(
        ...
        weight=1.0,
        params={
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_FOOT_FE"),
            "threshold": 5.0,
        },
    )
    ...
    test_gait_reward = RewTerm(
        ...
        params={
            ...
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_FOOT_FE"),
            "asset_cfg": SceneEntityCfg("robot", body_names=".*_FOOT_FE"),
        },
    )
